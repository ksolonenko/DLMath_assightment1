...
def fit_regression_model(X, y):
    ...
    num_epochs = 8000 # Pick a better number of epochs
    ...
    for epoch in range(1, num_epochs):
        ...
        if abs(loss.item() - previous_loss) < 0.001 : # Change this condition to stop the training when the loss is not changing much.
            break
